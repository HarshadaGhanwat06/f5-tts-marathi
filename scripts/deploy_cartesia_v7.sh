#!/usr/bin/env bash
#
# deploy_cartesia_v7.sh
#
# Deploy Cartesia_Rasa_Combined_v7 to the live services: FastAPI on port 8000
# and Gradio UI on port 7861.
#
# New checkpoint:
#   /root/f5-tts-marathi/f5tts/lib/python3.12/ckpts/Cartesia_Rasa_Combined_v7/model_last.pt
...
#   2. Force emotion_layer/synthesize.py to the v7 checkpoint + extended vocab.
#   3. Force the model identifier in emotion_layer/api.py to v7.
#   4. Restart FastAPI (8000) + Gradio UI (7861).
#   5. Validate health, model-info, and synthesis.
#   6. Print rollback procedure.
#
# Usage:
#   bash scripts/deploy_cartesia_v7.sh
#
set -euo pipefail
...
NEW_CKPT="/root/f5-tts-marathi/f5tts/lib/python3.12/ckpts/Cartesia_Rasa_Combined_v7/model_last.pt"
...
echo "============================================================"
echo " F5-TTS Marathi Deployment - Cartesia_Rasa_Combined_v7"
echo "============================================================"
...
perl -pi -e 's{(Rasa_Marathi_Emotion_Female|Cartesia_Rasa_Combined_3h|Cartesia_Rasa_Combined_v2|Cartesia_Rasa_Combined_v3|Cartesia_Rasa_Combined_v4|Cartesia_Rasa_Combined_v5|Cartesia_Rasa_Combined_v6)/model_last\.pt}{Cartesia_Rasa_Combined_v7/model_last.pt}g' "$API"
...
grep -n "Cartesia_Rasa_Combined_v7\|model_identifier" "$API" | head -10 || true
...
nohup "$PYTHON" -m uvicorn emotion_layer.api:app --host 0.0.0.0 --port $API_PORT \
    > "$LOG_DIR/api_deploy_v7.log" 2>&1 &
disown
NEW_API_PID=$!
echo "  Started new API process PID $NEW_API_PID (log: $LOG_DIR/api_deploy_v7.log)"
...
nohup "$PYTHON" emotion_layer/ui.py --port $UI_PORT \
    > "$LOG_DIR/ui_deploy_v7.log" 2>&1 &
disown
NEW_UI_PID=$!
echo "  Started new UI process PID $NEW_UI_PID (log: $LOG_DIR/ui_deploy_v7.log)"
...
grep -E "Loading|checkpoint|vocab|Error|Traceback|error" "$LOG_DIR/api_deploy_v7.log" | tail -30 || true
...
TEST_CASES=(
    "NEUTRAL|à¤®à¥€ à¤†à¤œ à¤¨à¤µà¥€à¤¨ à¤•à¥…à¤®à¥‡à¤°à¤¾ à¤µà¤¾à¤ªà¤°à¤²à¤¾."
    "NEUTRAL|à¤¤à¤¿à¤¨à¥‡ à¤•à¤¾à¤³à¥€ à¤¬à¥…à¤— à¤˜à¥‡à¤¤à¤²à¥€."
    "NEUTRAL|à¤˜à¤°à¤¾à¤¤ à¤—à¥…à¤¸ à¤¸à¤‚à¤ªà¤²à¤¾ à¤†à¤¹à¥‡."
    "NEUTRAL|à¤«à¥‹à¤¨à¤®à¤§à¥à¤¯à¥‡ à¤¨à¤µà¥€à¤¨ à¥²à¤ª à¤‡à¤¨à¥à¤¸à¥à¤Ÿà¥‰à¤² à¤•à¥‡à¤²à¤‚."
    "NEUTRAL|à¤®à¤²à¤¾ à¤¸à¤•à¤¾à¤³à¥€ à¤•à¥‰à¤«à¥€ à¤†à¤µà¤¡à¤¤à¥‡."
    "NEUTRAL|à¤†à¤œ à¤‘à¤«à¤¿à¤¸à¤šà¥€ à¤®à¤¹à¤¤à¥à¤¤à¥à¤µà¤¾à¤šà¥€ à¤®à¥€à¤Ÿà¤¿à¤‚à¤— à¤†à¤¹à¥‡."
    "NEUTRAL|à¤¤à¥à¤¯à¤¾à¤¨à¥‡ à¤…à¤‚à¤¤à¤°à¤¾à¤³à¤¾à¤¤ à¤°à¥‰à¤•à¥‡à¤Ÿ à¤ªà¤¾à¤¹à¤¿à¤²à¤‚."
    "NEUTRAL|à¤®à¥€ à¤•à¥à¤°à¤¿à¤•à¥‡à¤Ÿà¤šà¤¾ à¤¬à¥‰à¤² à¤µà¤¿à¤•à¤¤ à¤˜à¥‡à¤¤à¤²à¤¾."
    "NEUTRAL|à¤¹à¥‡ à¤¡à¥‰à¤•à¥à¤Ÿà¤° à¤°à¥à¤—à¥à¤£à¤¾à¤²à¤¯à¤¾à¤¤ à¤¤à¤ªà¤¾à¤¸à¤£à¥€ à¤•à¤°à¤¤à¤¾à¤¤."
    "NEUTRAL|à¤•à¤¾à¤à¤—à¥à¤°à¥‡à¤¸à¤šà¥€ à¤¸à¤­à¤¾ à¤¶à¤¹à¤°à¤¾à¤¤ à¤­à¤°à¤²à¥€ à¤†à¤¹à¥‡."
    "NEUTRAL|à¤¤à¤¿à¤¨à¥‡ à¤•à¤ à¤†à¤£à¤¿ à¤•à¥‰à¤‚ à¤…à¤¸à¤¾ à¤‰à¤šà¥à¤šà¤¾à¤° à¤•à¥‡à¤²à¤¾."
    "NEUTRAL|à¤µà¤¾! à¤•à¤¿à¤¤à¥€ à¤¸à¥à¤‚à¤¦à¤° à¤¡à¥à¤°à¥‰à¤‡à¤‚à¤— à¤•à¥‡à¤²à¥€à¤¯à¥‡. à¤¹à¤¾ à¤¸à¥à¤•à¥‡à¤š à¤®à¤²à¤¾ à¤¬à¥à¤¯à¥‚à¤Ÿà¤¿à¤«à¥à¤² à¤µà¤¾à¤Ÿà¤²à¤¾!"
    "NEUTRAL|thank you"
    "SAD|à¤†à¤œ à¤–à¥‚à¤ª à¤¦à¤¿à¤µà¤¸ à¤•à¤ à¥€à¤£ à¤—à¥‡à¤²à¤¾."
    "HAPPY|à¤†à¤œ à¤–à¥‚à¤ª à¤†à¤¨à¤‚à¤¦à¥€ à¤¦à¤¿à¤µà¤¸ à¤†à¤¹à¥‡."
    "ANGRY|à¤¹à¥‡ à¤•à¤¾à¤¯ à¤•à¤°à¤¤à¥‹à¤¯à¤¸ à¤¤à¥‚!"
    "FEAR|à¤®à¤²à¤¾ à¤–à¥‚à¤ª à¤­à¥€à¤¤à¥€ à¤µà¤¾à¤Ÿà¤¤ à¤†à¤¹à¥‡."
    "DISGUST|à¤¹à¥‡ à¤–à¤°à¤‚à¤š à¤˜à¥ƒà¤£à¤¾à¤¸à¥à¤ªà¤¦ à¤†à¤¹à¥‡."
)
...
for tc in "${TEST_CASES[@]}"; do
    i=$((i+1))
    emotion="${tc%%|*}"; text="${tc#*|}"
    out_file="$REPO_ROOT/validation_output/test_v7_${i}.wav"
...
' 2>/dev/null)
    if [[ -z "$base64str" || "$base64str" == "__PARSE_ERR__" ]]; then
        ...
        echo "    log:  $(tail -3 "$LOG_DIR/api_deploy_v7.log")"
        continue
    fi
...
echo "      cd $REPO_ROOT && nohup $PYTHON -m uvicorn emotion_layer.api:app --host 0.0.0.0 --port $API_PORT > $LOG_DIR/api_rollback_v7.log 2>&1 & disown"
echo "      kill \$(ss -ltnp | grep ':$UI_PORT ' | grep -oP 'pid=\\K[0-9]+' | head -1); sleep 3"
echo "      cd $REPO_ROOT && nohup $PYTHON emotion_layer/ui.py --port $UI_PORT > $LOG_DIR/ui_rollback_v7.log 2>&1 & disown"
echo "============================================================"
echo ""
echo "IMPORTANT: Confirm the API startup log loaded Cartesia_Rasa_Combined_v7"
